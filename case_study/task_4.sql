...
SELECT kh.ma_khach_hang, kh.ho_ten, lk.ten_loai_khach, hd.ma_hop_dong, dv.ten_dich_vu, hd.ngay_lam_hop_dong, hd.ngay_ket_thuc, IFNULL((IFNULL(hdct.so_luong*dvdk.gia,0)+dv.chi_phi_thue),0) AS tong_tien
FROM khach_hang kh
INNER JOIN loai_khach lk ON lk.ma_loai_khach=kh.ma_loai_khach
